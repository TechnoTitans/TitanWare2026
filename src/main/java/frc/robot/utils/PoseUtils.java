...
public class PoseUtils {
    ...
    public static Pose2d flip(final Pose2d pose2d) {
        ...
        return new Pose2d(
                FieldConstants.fieldLength - pose2d.getX(),
                pose2d.getY(),
    ...
    public static boolean isInField(final Pose3d pose3d) {
        return pose3d.getX() >= -FIELD_WITHIN_BORDER_MARGIN
                && pose3d.getX() <= FieldConstants.fieldLength + FIELD_WITHIN_BORDER_MARGIN
                && pose3d.getY() >= -FIELD_WITHIN_BORDER_MARGIN
                && pose3d.getY() <= FieldConstants.fieldWidth + FIELD_WITHIN_BORDER_MARGIN
