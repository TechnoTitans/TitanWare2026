...
public class IntakeRollersIOReal implements IntakeRollersIO {
    ...
    public IntakeRollersIOReal(final HardwareConstants.IntakeRollerConstants constants) {
        ...
        this.masterMotor = new TalonFX(constants.masterMotorId(), canBus.toPhoenix6CANBus());
        this.followerMotor = new TalonFX(constants.followerMotorId(), canBus.toPhoenix6CANBus());
